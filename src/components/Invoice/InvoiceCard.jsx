const InvoiceCard = ({ title, subTitle, statusHeader, body, footer }) => {
  return (
    <div className="h-40 mx-6 my-3 py-1 px-2 bg-white rounded-lg border border-gray-200 shadow-sm text-gray-900">
      {/* // * Header Invoice, option: [success, pending, canceled, null] */}
      <div className="border-b-2 px-2 pb-1 flex flex-row wrap justify-between items-center">
        <div>
      ...
      {/* // * Body Invoice */}
      <div className="text-xs max-h-20 pt-1 px-3">
      ...
      {/* // * Footer Invoice */}
      <div className="text-xs flex flex-row-reverse flex-wrap justify-between">
